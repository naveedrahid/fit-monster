            ...
            <div class="card-body">
                <form
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 col-lg-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <select id="gender" name="gender"
                                    ...
                                    <option value="" disabled {{ old('gender', $shift->gender) == '' ? 'selected' : '' }}>
                                        Select Gender
                                    </option>
                                    <option value="male" {{ old('gender', $shift->gender) == 'male' ? 'selected' : '' }}>
                                        Male
                                    </option>
                                    <option value="female" {{ old('gender', $shift->gender) == 'female' ? 'selected' : '' }}>
                                        Female
                                    </option>
                                </select>
                                @error('gender')
                        ...
                        <div class="col-12">
                            <div class="my-3">
                                <button type="submit" class="btn btn-primary">{{$shift->exists ? 'Update': 'Create'}}</button>
                            </div>
                        </div>
                    </div>
                </form>
